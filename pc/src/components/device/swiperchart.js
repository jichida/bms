...
export class Chart1 extends React.Component {
    ...
    render() {
        ...
        return (
            <Chart height={400} width={300} data={data} scale={cols} padding={[ 0, 0, 200, 0 ]} forceFit>
              ...
              <Guide>
                ...
                style={{ // 底灰色
                  ...
                  <Html position={[ '50%', '95%' ]} html={() => {return ('<div style="width: 300px;text-align: center;font-size: 12px!important;"><p style="font-size: 12px; color: rgba(0,0,0,0.43);margin: 20px 0 0 0;">合格率</p><p style="font-size: 20px;color: rgba(0,0,0,0.85);margin: 0;">'+ data[0].value * 10+'%</p></div>')}} />
              </Guide>
...
export class Chart2 extends React.Component {
    render() {
        ...
        return (
            <Chart height={300} width={300} data={data} scale={cols} forceFit>
                <Axis name="year" />
                <Axis name="value" />
...
export class Chart3 extends React.Component {
    render() {
        const data = 40;
        return (
            <div className="wenduchart" style={{paddingTop:"20px"}}>
                <img src={Wendu} />
                <span style={{height: `${data}px`}}></span>
            </div>
        )
    }
}
