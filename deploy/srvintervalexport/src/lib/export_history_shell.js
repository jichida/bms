...
const startexport_do = (DeviceId,exportdir,curday,callbackfn) =>{
  ...
  const fields = null;
  const csvfields_query = 'DeviceId,DataTime,UpdateTime,BAT_U_OUT_HVS,BAT_U_TOT_HVS,BAT_I_HVS,\
...
BAT_T_AVG,BAT_T_MAX_CSC,BAT_T_MIN_CSC,BAT_USER_SOC_HVS,BAT_UCELL_AVG,alarmtxtstat,ALIV_ST_SW_HVS,\
